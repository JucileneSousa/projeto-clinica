            ...
            @foreach ($pacientes as $paciente)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('prontuarios.show', $paciente->id)}}" class="btn btn-outline-info" role="button"> <i class="fa fa-clipboard"></i> Prontuário</a>
                        <a href="#" class="btn btn-outline-info" role="button"> <i class="fa fa-comment"></i> Assessor</a>
                        <a href="#" class="btn btn-outline-info" role="button"> <i class="fa fa-id-card"></i> Histórico de Visitas</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
